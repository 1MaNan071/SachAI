...
**CRITICAL OUTPUT REQUIREMENT**: The 'verdict' field in your response MUST be one of the exact, case-sensitive strings: "Supported" or "Refuted". Do not use any other capitalization.
